...
module.exports = "<p>chat name: {{ chat.name }}</p>"
...
module.exports = "<app-chat-item *ngFor=\"let chatItem of chats\" [chat]=\"chatItem\"></app-chat-item>\r\n<button (click)=\"clearChats()\">Clear</button>"
...
var ChatService = (function () {
    function ChatService() {
        this.chats = [
            new __WEBPACK_IMPORTED_MODULE_0__chat_model__["a" /* Chat */]('fer'),
            new __WEBPACK_IMPORTED_MODULE_0__chat_model__["a" /* Chat */]('frutaria')
        ];
...
var CommunicationService = (function () {
    function CommunicationService(winref, chatService) {
        var _this = this;
        this.winref = winref;
        this.chatService = chatService;
        this.receiveMessage = function (e) {
            ...
            if (e.data.type === 'chats') {
                _this.chatService.setChats(e.data.value);
            }
        };
...
CommunicationService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__windowref__["a" /* WindowRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__windowref__["a" /* WindowRef */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__chat_service__["a" /* ChatService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__chat_service__["a" /* ChatService */]) === "function" && _b || Object])
